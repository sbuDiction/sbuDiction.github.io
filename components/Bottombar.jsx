  ...
  return (
    <footer className={styles.bottomBar}>
      <div className={styles.container}>
        <a
          href="https://github.com/sbuDiction/sbuDiction.github.io"
          target="_blank"
      ...
      <div className={styles.container}>
        <a href="https://www.linkedin.com/in/sibusiso-nkosi-9a7018223/" target="_blank" rel="noopener">
          <div className={styles.section}>
            <LinkedinIcon className={styles.icon} />
            <p>Linkedin</p>
          </div>
        </a>
        <a href="https://github.com/sbuDiction" target="_blank" rel="noopener">
          <div className={styles.section}>
